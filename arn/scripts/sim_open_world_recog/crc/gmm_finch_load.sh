...
#$ -N sim_gmm_L
#$ -q long
#$ -o /scratch365/dprijate/osr/har/logs/sims/gmmf/
#$ -e /scratch365/dprijate/osr/har/logs/sims/gmmf/
...
apptainer exec \
    ...
    dsp_arn/arn/scripts/sim_open_world_recog/crc/apptainer_exec_gmm_load.sh
